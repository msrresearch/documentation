...
# -*- coding: utf-8 -*-
#
# FaceReader Client documentation build configuration file, created by
...
#sys.path.insert(0, os.path.abspath('../../FaceReader'))
sys.path.append('/home/bjoern/hiwi/facereader_client')
